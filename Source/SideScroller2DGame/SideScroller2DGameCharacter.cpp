...
void ASideScroller2DGameCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
...
//	Cast<> GetController()
	...
	if (PC)
	{
		...
		if (id == 0)
		{
			...
			PlayerInputComponent->BindAxis("MoveRight_Keyboard1", this, &ASideScroller2DGameCharacter::MoveRight);
		}
		else if (id ==1 )
		{
			...
			PlayerInputComponent->BindAxis("MoveRight_Keyboard2", this, &ASideScroller2DGameCharacter::MoveRight);
		}
	}
...
void ASideScroller2DGameCharacter::TouchStarted(const ETouchIndex::Type FingerIndex, const FVector Location)
{
	// jump on any touch
	Jump();
}

void ASideScroller2DGameCharacter::TouchStopped(const ETouchIndex::Type FingerIndex, const FVector Location)
{
	StopJumping();
}
